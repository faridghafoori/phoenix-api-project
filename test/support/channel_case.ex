defmodule PhoenixApiProjectWeb.ChannelCase do
  @moduledoc """
  ...
  by setting `use PhoenixApiProjectWeb.ChannelCase, async: true`, although
  ...
  using do
    quote do
      ...
      import PhoenixApiProjectWeb.ChannelCase
